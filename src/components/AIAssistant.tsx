...
export default function AIAssistant() {
  const [state, formAction] = useFormState(getGlassesRecommendation, initialState);
  ...
  return (
    <section id="ai-assistant" className="w-full py-12 md:py-24 lg:py-32 bg-primary/5">
        ...
        <div className="mx-auto max-w-3xl">
          <Card className="shadow-lg border-primary/20">
            <CardHeader className="text-center">
              ...
              <CardTitle className="font-headline text-3xl md:text-4xl text-primary">AI Style Assistant</CardTitle>
              <CardDescription className="text-lg">
                Tell us what you need, and our AI will find the perfect pair for you.
              </CardDescription>
            </CardHeader>
            <CardContent>
